...
class TrafficController:
    ...
    def get_lanes(self, double_lane: DoubleLane):
    ...
    def create_traffic_light(self, x, y, lane: Lane):
        self.traffic_lights[lane] = TrafficLight(x, y, lane, self.traffic_light_images, self.surface)
    ...
    def get_traffic_lights(self, double_lane: DoubleLane):
        return [traffic_light for lane, traffic_light in self.traffic_lights.items()]
